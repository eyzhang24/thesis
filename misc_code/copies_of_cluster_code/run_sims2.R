...
# check on status of job
get_job_status(runresplg)$completed
system('squeue --me')
...
#### TO DO: RUN ORACLE MODEL W/ CHEMS ONLY FOR R^2
...
run_mlr_lg <- function() {
  ...
  return(list(mlrl, mlrtimel, oraclel, oracletimel, chems_onlyl, chems_oraclel))
}
...
#bkmr 13, 14, 15, 16, 17 need two more
