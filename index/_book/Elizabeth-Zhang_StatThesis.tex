...
\toprule
\multicolumn{2}{c}{\textbf{ }} & \multicolumn{3}{c}{\textbf{Small (n=250)}} & \multicolumn{2}{c}{\textbf{Large (n=1000)}} \\
...
\bottomrule
\multicolumn{7}{l}{\textsuperscript{*} \makecell[l]{"Collapsed" refers to scenarios where the smallest three race categories are collapsed\\into one stratified model.}}\\
\multicolumn{7}{l}{\textsuperscript{\dag} Original n=27}\\
\multicolumn{7}{l}{\textsuperscript{\ddag} Original n=109}\\
\end{tabular}
\end{table}
