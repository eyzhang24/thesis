...
\tightlist
\item
  Lazarevic et al. (2020) compares a braod range methods for variable selection (including bkmr)
\item
  Hoskovec et al. (2021) compares general performance of broad range of methods (including bkmr)
\item
  Pesenti et al. (2023) compares three bayesian approaches for variable selection (including bkmr and bsr)
\item
  Lampa, Lind, Lind, \& Bornefalk-Hermansson (2014) study of interactions only w/ bayesian additive reg trees
\item
  Barrera-Gómez et al. (2017) study of interaction effects, does not include more recent developments
\item
  Keil et al. (2020) ex. simulation study w/ birth weights
\end{itemize}
\hypertarget{methods}{%
...
\tightlist
\item
  Bastain et al. (2019) original study design paper
\item
  Howe et al. (2020) applied BKMR and BSR to this data, what did they find?
\end{itemize}
...
\leavevmode\vadjust pre{\hypertarget{ref-keil_quantile-based_2020}{}}%
Keil, A. P., Buckley, J. P., O, 'Brien. K. M., Ferguson, K. K., Zhao, S., \& White, A. J. (2020). A {Quantile}-{Based} g-{Computation} {Approach} to {Addressing} the {Effects} of {Exposure} {Mixtures}. \emph{Environmental Health Perspectives}, \emph{128}(4), 047004. http://doi.org/\href{https://doi.org/10.1289/EHP5838}{10.1289/EHP5838}
...
\leavevmode\vadjust pre{\hypertarget{ref-lampa_identification_2014}{}}%
Lampa, E., Lind, L., Lind, P. M., \& Bornefalk-Hermansson, A. (2014). The identification of complex interactions in epidemiology and toxicology: A simulation study of boosted regression trees. \emph{Environmental Health}, \emph{13}(1), 57. http://doi.org/\href{https://doi.org/10.1186/1476-069X-13-57}{10.1186/1476-069X-13-57}
