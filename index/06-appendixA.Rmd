...
```{r nsmunivp, fig.cap = "naive small univariate p-values.", out.width = '75%', echo = FALSE}
# naive small
include_graphics(path = "figures/ch4_nsm_univ_pval.png")
```


```{r nlgunivp, fig.cap = "naive large univariate p-values.", out.width = '75%', echo = FALSE}
# naive large
include_graphics(path = "figures/ch4_nlg_univ_pval.png")
```


```{r osmunivp, fig.cap = "oracle small univariate p-values.", out.width = '75%', echo = FALSE}
# oracle small
include_graphics(path = "figures/ch4_osm_univ_pval.png")
```


```{r olgunivp, fig.cap = "oracle large univariate p-values.", out.width = '75%', echo = FALSE}
# oracle large
include_graphics(path = "figures/ch4_olg_univ_pval.png")
```


```{r ksmunivp, fig.cap = "bkmr small univariate pip's.", out.width = '75%', echo = FALSE}
# bkmr small
include_graphics(path = "figures/ch4_ksm_univ_pips.png")
```


```{r klgunivp, fig.cap = "bkmr large univariate pip's.", out.width = '75%', echo = FALSE}
# bkmr large
include_graphics(path = "figures/ch4_klg_univ_pips.png")
```


```{r ssmunivp, fig.cap = "bsr small univariate pip's.", out.width = '75%', echo = FALSE}
# bsr small
include_graphics(path = "figures/ch4_ssm_univ_pips.png")
```


```{r slgunivp, fig.cap = "bsr large univariate pip's.", out.width = '75%', echo = FALSE}
# bsr large
...
```{r osmbivp, fig.cap = "oracle small detection of interactions.", out.width = '75%', echo = FALSE}
# oracle small
include_graphics(path = "figures/ch4_osm_biv_pval.png")
```

```{r olgbivp, fig.cap = "oracle large detection of interactions.", out.width = '75%', echo = FALSE}
...
comb_sens |> 
  ...
  kbl(booktabs = TRUE, digits = 2, #align = "lcc",
      caption = "Sensitivity of univariate chemicals in all scenarios with interactions between exposures.", 
...
comb_sens |> 
  ...
  select(c(1, 2, 11:16)) |> 
  kbl(booktabs = TRUE, digits = 2, #align = "lcc",
      caption = "False discovery rate of univariate chemicals in all scenarios with interactions between exposures.", 
      col.names = c("Type", "Effect size", 
...
Figures \@ref(fig:ksmcdas)-\@ref(fig:slgnico) display the estimated exposure-response surface for one chemical while fixing one (or two, for three-way interactions) other chemicals at their 0.1, 0.5, and 0.9 quantiles, for all scenarios not included in Chapter \@ref(univsenschap).

```{r ksmcdas, fig.cap = "cd-as bkmr small exposure response.", out.width = '75%', echo = FALSE}
include_graphics(path = "figures/ch4_ksm_biv_expresp_2.png")
```

```{r ssmcdas, fig.cap = "cd-as bsr small exposure response.", out.width = '75%', echo = FALSE}
include_graphics(path = "figures/ch4_ssm_biv_expresp_2.png")
```

```{r klgcdas, fig.cap = "cd-as bkmr large exposure response.", out.width = '75%', echo = FALSE}
include_graphics("figures/ch4_klg_biv_expresp_2.png")
```


```{r slgcdas, fig.cap = "cd-as bsr large exposure response.", out.width = '75%', echo = FALSE}
include_graphics("figures/ch4_slg_biv_expresp_2.png")
```


```{r ksmnico, fig.cap = "ni-co bkmr small exposure response.", out.width = '75%', echo = FALSE}
include_graphics("figures/ch4_ksm_biv_expresp_3.png")
```

```{r ssmnico, fig.cap = "ni-co bkmr small exposure response.", out.width = '75%', echo = FALSE}
include_graphics("figures/ch4_ssm_biv_expresp_3.png")
```

```{r klgnico, fig.cap = "ni-co bkmr large exposure-response.", out.width = '75%', echo = FALSE}
include_graphics("figures/ch4_klg_biv_expresp_3.png")
```


```{r slgnico, fig.cap = "ni-co bkmr large exposure-response.", out.width = '75%', echo = FALSE}
...
```{r ksmtri, fig.cap = "triv bkmr small exposure-resposnse.", out.width = '75%', echo = FALSE}
include_graphics("figures/ch4_ksm_triv_expresp.png")
```

```{r klgtri, fig.cap = "triv bkmr large exposure-resposnse.", out.width = '75%', echo = FALSE}
include_graphics("figures/ch4_klg_triv_expresp.png")
```

```{r ssmtri, fig.cap = "triv bsr small exposure-resposnse.", out.width = '75%', echo = FALSE}
include_graphics("figures/ch4_ssm_triv_expresp.png")
```

```{r slgtri, fig.cap = "triv bsr large exposure-resposnse.", out.width = '75%', echo = FALSE}
...
univ_re_wide |> 
  ...
  kbl(booktabs = TRUE, escape = FALSE, 
      align = "llcccc", 
      caption = "univariate re sensitivity.", 
