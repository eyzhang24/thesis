...
For our sake, when we refer to "interaction," we mean any non-additive interaction. We consider such non-additive interactions to be complex, meaning that they are difficult to detect. To see why, let us consider running a linear regression for $Y$ on $x_1$ and $x_2$. The regression would be defined as
...
```{r toy3, fig.cap="Fitted kernel machine regression (blue) with $\\rho=2$ compared to the true distribution (orange).", out.width = '75%', echo = FALSE}
...
```{r toy4, fig.cap="Linear spline regression (blue) with four knots (dotted lines) compared to the true distribution (orange).", out.width = '75%', echo = FALSE}
...
```{r toy5, fig.cap="Cubic spline regression (blue) with four knots (dotted lines) compared to the true distribution (orange).", out.width = '75%', echo = FALSE}
...
```{r toy6, fig.cap="Natural spline regression (blue) with four knots (dotted lines) compared to the true distribution (orange).", out.width = '75%', echo = FALSE}
...
```{r toybounds, fig.cap="Natural and cubic spline regression (blue) compared to the true distribution (orange) extrapolated outside the bounds of $x$ (dotted lines).", out.width = '100%', echo = FALSE}
