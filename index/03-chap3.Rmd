...
```{r toy5, fig.cap="Cubic spline regression", out.width = '75%', echo = FALSE}
include_graphics(path = "figures/ch3_toy5.png")
```

```{r toy6, fig.cap="Natural spline regression", out.width = '75%', echo = FALSE}
include_graphics(path = "figures/ch3_toy6.png")
```

```{r toybounds, fig.cap="Natural and cubic spline regression extrapolated outside the bounds of $x$", out.width = '100%', echo = FALSE}
