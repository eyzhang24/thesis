...
```{r univexpsim, fig.cap="Distributions of exposures from observed data (blue) and simulated data (gray).", out.width = '75%', echo = FALSE}
include_graphics(path = "figures/ch4_univ_exp_sim.png")
```

```{r univcovsim, fig.cap = "Distributions of covariates from observed data (blue) and simulated data (gray).", out.width = '75%', echo = FALSE}
...
```{r corsims, fig.cap = "Correlation heat maps of exposures from observed data (a) and averaged from simulated data (b), as well as distribution of correlations from simulated data (c).", out.width = '100%', echo = FALSE}
...
*include similar plots for larger dataset?*
