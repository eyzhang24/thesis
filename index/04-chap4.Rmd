...
Table \@ref(tab:twowaytab) summarizes the sensitivity of the oracle MLR, BKMR, and BSR for two-way interactions. The oracle MLR consistently has much greater sensitivity for interactions than both BKMR and BSR. In smaller size datasets, we designed the higher effect size of interactions such that the oracle MLR would have a sensitivity of around 0.5, which is confirmed in these results. In comparison, [*finish this!*]
