...
comb_sens |> 
  ...
  kbl(booktabs = TRUE, escape = FALSE, digits = 3, align = "lcc",
      caption = "Sensitivity and false discovery rate (FDR) of chemicals in all scenarios with interactions between exposures.", 
...
comb_int |> 
  ...
  kbl(booktabs = TRUE, escape = FALSE, 
      align = "llcccccc", 
      caption = "Sensitivity to interactions in all scenarios with interactions between exposures.", 
...
Include a table of false discovery rates for BSR and BKMR
