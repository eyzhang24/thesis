...
base_sens2 |> 
  ...
  kbl(booktabs = TRUE, escape = FALSE, 
      ...
      align = "lcccccccccc",
      caption = "Detection rate of chemicals in base case scenario.") |> 
  column_spec(1, width = "6em") |>
  add_header_above(header = c(" " = 1, "Significant" = 4, "Insignificant" = 6)) |>
...
Probably only include results from Hg and Ni here, move everything else to appendix

- naive and oracle do p-values
- bsr and bkmr do pips

```{r, out.width = '75%', echo = FALSE}
# basecasesig, fig.cap = "P-value distributions from smaller (a) and larger (b) size datasets and PIP distributions from smaller (c) and larger (d) size datasets.", out.width = '100%', echo = FALSE
...
comb_sens |> 
  ...
  kbl(booktabs = TRUE, escape = FALSE, digits = 3, align = "lcc",
      caption = "Detection rate of chemicals in all scenarios with interactions between exposures.") |> 
  column_spec(1, width = "6em") |>
