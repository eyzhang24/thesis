...
Next, we ran BKMR using the `bkmr` package in R [@bobb_statistical_2018, @bobb_bkmr_2022]. Following the approach by @howe_prenatal_2020, we 

- component-wise selection
- default priors
- 50,000, first half removed for burn-in

Finally, we ran 

- default priors
- 5,000 to select degrees of freedom using WAIC approach 
- 50,000 each for empirical bayes and then actual model fitting, first half removed for burn-in
