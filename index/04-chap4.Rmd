...
```{r univexpsim, fig.cap="Exposure distributions from simulation.", out.width = '75%', echo = FALSE}
include_graphics(path = "figures/ch4_univ_exp_sim.png")
```

```{r univcovsim, fig.cap = "Covariate distributions from simulation.", out.width = '75%', echo = FALSE}
...
```{r corheatmap, fig.cap = "Correlation heatmaps from original and simulation.", out.width = '100%', echo = FALSE}
include_graphics(path = "figures/ch4_corr_sim+orig.png")
```

```{r cordens, fig.cap = "Density of correlations from simulation.", out.width = '100%', echo = FALSE}
include_graphics(path = "figures/ch4_corr_sim.png")
```
