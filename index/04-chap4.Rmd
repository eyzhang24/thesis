...
Similar to the Ni-Co case, it is difficult to determine whether these patterns are due to 

[*potentially get two way interactions for HgNi*]

[*discuss in methods how we got the confidence intervals*]
