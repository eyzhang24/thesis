...
Next, we use copulas to simulate predictor data. We use the `copula` and `rslurm` packages in this section. This code was run on FrostByte, the Amherst high-performance computing cluster (HPC) RStudio server. 
...
Here, we create the tables and figures presented in Chapter \@ref(results)
