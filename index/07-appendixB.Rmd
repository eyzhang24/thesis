...
univ_re_wide |> 
  ...
  kbl(booktabs = TRUE, escape = FALSE, 
      align = "llcccc", 
      caption = paste0("Sensitivity for the univariate Hg term in all scenarios with an interaction", "
                       between the categorical race covariate and Hg. Sensitivities for BKMR and BSR", "
                       models are stratified by race."), 
