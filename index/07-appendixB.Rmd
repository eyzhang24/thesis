...
Here, we create the visualization of $R^2$ values in multiple linear regressions with the true functional form of the chemicals specified, in order to ensure we are achieving a realistic signal-to-noise ratio. 

[*include code from cluster on fitting chem-only models*]
